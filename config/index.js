export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx55b7dcc0ae5763fd",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "41f2f9c689995d2507c9bd1d591c2433",
  ...
  USERS: [
    {
      ...
      id: "opGT86qhe3dF36rRVq_UH9qECYFU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "",
      // 所在省份
      province: "内蒙古",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小秋研", "year": "1999", "date": "10-04"},
  
       
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "大春砸", "year": "1996", "date": "09-31"},
